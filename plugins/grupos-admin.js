...
await conn.sendMessage(NumeroUser + '@s.whatsapp.net', { text: `*Soy ${packname}, un Bot para WhatsApp creado por @Not.Sxrgio.*\n\n:¨·.·¨:\n\`·. ${groupMetadata.subject}`, contextInfo: { externalAdReply: { title: '🦎 ¡Te esperamos con ansias en el grupo! 🦎', body: '9999999999', thumbnailUrl: pp, sourceUrl: link, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true }}})
